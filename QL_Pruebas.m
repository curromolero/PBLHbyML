...
%%    
 ...
 %% Resultado de nuestro algoritmo
    plot(ejeX, Clouds_3layer(:, 1), '*w', ejeX, Clouds_3layer(:, 2), '*c', ejeX, Clouds_3layer(:, 3), '*m'); % Cloud base
    hold off;
 %% Comparacion ambas estimaciones
    figure;
    subplot(1,3,1);
    plot(var(41).Datos(1, :), Clouds_3layer(:, 1), '+k'); % Cloud base layer 1
    subplot(1,3,2);
    plot(var(41).Datos(2, :), Clouds_3layer(:, 2), '+c'); % Cloud base layer 2
    subplot(1,3,3);
    plot(var(41).Datos(3, :), Clouds_3layer(:, 3), '+m'); % Cloud base layer 3
